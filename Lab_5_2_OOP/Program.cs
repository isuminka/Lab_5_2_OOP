...
namespace Lab_5_2_OOP
{
    abstract class Course
    {
        ...
        public void AddTask(List<PracticeTask> tasks)
        {
            Console.Write("Назва: ");
        ...
        public void EditTask(List<PracticeTask> tasks)
        {
        ...
        public void RemoveTask(List<PracticeTask> tasks)
        {
        ...
        public void ShowTasks(List<PracticeTask> tasks)
        {
            Console.WriteLine("+----------------------------+------------------+-----------------+-------------------------+---------------------+");
        ...
        abstract public void AverageAmountStudents(List<PracticeTask> tasks);
        abstract public void MaxAmountStudents(List<PracticeTask> tasks);
        abstract public void SearchWithSubstring(List<PracticeTask> tasks);
    ...
    class PracticeTask : Course
    {
        ...
        public override void AverageAmountStudents(List<PracticeTask> tasks)
        {
            int i = 0;
            double p = 0;
        ...
        public override void MaxAmountStudents(List<PracticeTask> tasks)
        {
        ...
        public override void SearchWithSubstring(List<PracticeTask> tasks)
        {
    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            while (true)
            {
                ...
                if (k == 2) tasks[0].EditTask(tasks);
                else if (k == 3) tasks[0].RemoveTask(tasks);
                else if (k == 4) tasks[0].ShowTasks(tasks);
                else if (k == 5) tasks[0].AverageAmountStudents(tasks);
                else if (k == 6) tasks[0].MaxAmountStudents(tasks);
                else if (k == 7) tasks[0].SearchWithSubstring(tasks);
                else if (k == 0) break;
            }
        }
    }
